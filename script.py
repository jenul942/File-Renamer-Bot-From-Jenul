...
<b>Send me any Telegram file and choose appropriate option! </b>"""
    ...
    UPGRADE_TEXT = ">> Are you want to upgrade contact @JenulRanthisa"
    DOWNLOAD_START = "Give Me Some Time..."
    UPLOAD_START = "Starting to upload..."
    AFTER_SUCCESSFUL_UPLOAD_MSG = "**Thank you for Using Me > ©  @JenulRanthisa **"
    ...
    CUSTOM_CAPTION_UL_FILE = "File was renamed by @FileRenamerJRBot"
